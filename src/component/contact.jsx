...
import LocationOnIcon from '@mui/icons-material/LocationOn';
 function Contact() {
  ...
  return (
    ...
    <br/>
    <h1 style={{marginLeft:'920px',fontSize:'50px',fontWeight:'600'}}>Contact Us</h1><br />
    ...
    <Carousel>
      <Carousel.Item interval={500}>
        <img src={require('../assets/c1.jpeg')} alt="" height={400} width={2000}/>
      </Carousel.Item>
      <Carousel.Item interval={300}>
      <img src={require('../assets/c2.jpeg')} alt=""  height={400} width={2000}/>
      </Carousel.Item>
      <Carousel.Item interval={300}>
      <img src={require('../assets/s3.webp')} alt=""  height={400} width={2000}/>
      </Carousel.Item>
    </Carousel>
    </div><br/>
    <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}sx={{bgcolor:'white',maxWidth:'2200px',marginLeft:'5px',borderRadius:'10px',height:'750px'}}>
  <Grid xs={4} sx={{marginTop:'100px'}}>
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2977.57266017857!2d78.79955069034628!3d10.385313661083183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b00782d25029679%3A0x4503e2d3b4a3897f!2z4K6q4K-B4K6k4K-B4K6V4K-N4K6V4K-L4K6f4K-N4K6f4K-ILCDgrqTgrq7grr_grrTgr40g4K6o4K6-4K6f4K-BIDYyMjAwMw!5e1!3m2!1sta!2sin!4v1722003029697!5m2!1sta!2sin" width="600" height="515" style={{border:'0',boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)',borderRadius: '10px'}} 
